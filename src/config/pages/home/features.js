...
const features = {
  ...
  items: [
    [
      {
        title: 'Bass',
        description: 'We use only the finest of subs to make your innards shake and the cows moo.',
        icon: 'tabler:device-speaker',
      },
      {
        title: 'Lights',
        description: 'We have a full lighting setup including a custom build LED wall',
        icon: 'tabler:bulb',
      },
      {
        title: 'Lasers',
        description: 'Our lighting setup also includes lasers because what is electronic music without lasers?',
        icon: 'tabler:ad-2',
      },
    ],
    [
      {
        title: 'Live DJs',
        description: 'We have a full lineup of DJs who are our friends and share the love of electronic music.',
        icon: 'tabler:headphones',
      },
      {
        title: 'Fireworks',
        description: 'EDF takes place near the 4th of July so naturally we have fireworks.',
        icon: 'tabler:stars',
      },
      {
        title: 'Food & Drinks',
